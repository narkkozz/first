...
const movies = [
  ...
  },
  {
    ...
    rating: 8.4,
    description:
      "An ordinary science teacher who wakes up in deep space with amnesia, tasked with saving Earth from a sun-eating microorganism called Astrophage.",
  },
];
...
function MovieCard({
  ...
  return (
    <article className="max-w-sm overflow-hidden rounded-lg bg-white text-slate-950 shadow-lg">
      <img
